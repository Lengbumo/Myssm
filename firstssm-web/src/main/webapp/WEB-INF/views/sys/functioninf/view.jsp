...
<form class="layui-form layui-row layui-col-space10" id="dform" enctype="multipart/form-data" method="post" action="" onsubmit="return false">
	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="functionIcon" id="functionIcon" lay-verify="required" autocomplete="off" value=""/>
			</div>
		</div>
		<div class="layui-inline">
...
<!-- 引入自定义js -->
<script type="text/javascript" src="${CTX_PATH }/static/loc/js/sys/functioninf/view.js"></script>
</body>
</html>
