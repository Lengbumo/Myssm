...
<script type="text/html" id="viewTpl">
	<a lay-event="detail" style="color:#01aaed" href="javascript:;" title="详情">{{d.operMethod }}</a>
</script>
<!-- 列表操作结束 -->
<!-- 引入自定义js -->
<script type="text/javascript" src="${CTX_PATH }/static/loc/js/sys/operationlog/list.js"></script>
</body>
</html>
