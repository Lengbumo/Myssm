layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'jquery'], function () {	
    ...
    table.render({
        ...
        url: my.window.ctxPath + '/myssm/manager/functioninf/page',
        method: 'POST', //方式
        page: true,//是否开启分页
        ...
        cols: [[ //标题栏
            ...
            {type:'checkbox'},
            {field:'functionCode', title:'功能编码',  align:'center', sort:true},
            {field:'functionName', title:'功能名称',  align:'center', sort:true},
            {field:'functionUrl', title:'功能地址',  align:'center', sort:true},
            {field:'functionSort', title:'排序',  align:'center', sort:true},
            {field:'functionIcon', title:'功能图标',  align:'center', sort:true},
            {field:'menuId', title:'所属菜单ID', minWidth:200, align:'center', sort:true},
        ...
        layer.open({
            ...
            success: function (layero) {
                ...
                btn.find('.layui-layer-btn0').on('click', function () {
                    ...
                    $.ajax({
                        url: my.window.ctxPath + '/myssm/manager/functioninf/bulkDelete',
                        data: ids,
